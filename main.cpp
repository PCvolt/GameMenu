...
#define assert_equal(value1, value2)                                                                                   \
	if ((value1) != (value2))                                                                                          \
	std::cerr << "Assertion failed. File " << __FILE__ << " line " << __LINE__ << " in function " << __FUNCTION__      \
			  << std::endl                                                                                             \
...
MenuElements::Window initResourcesWindow()
{
	...
	elementList.appendElementToList(MenuElements::LabelledItem(
		"P1 Health", { MenuElements::Label("P1 Health", "P1 Health"), MenuElements::Slider("Stance", { 0, 100 }) }));
	elementList.appendElementToList(MenuElements::LabelledItem(
		"P1 Health", { MenuElements::Label("P2 Health", "P2 Health"), MenuElements::Slider("Stance", { 0, 100 }) }));
	elementList.appendElementToList(MenuElements::LabelledItem(
		"P1 Health", { MenuElements::Label("P1 Meter", "P1 Meter"), MenuElements::Slider("Stance", { 0, 100 }) }));
	elementList.appendElementToList(MenuElements::LabelledItem(
		"P1 Health", { MenuElements::Label("P2 Meter", "P2 Meter"), MenuElements::Slider("Stance", { 0, 100 }) }));
...
void initTrainingWindow()
{
	...
	MenuElements::Select stanceSelect("Stance", { MenuElements::MenuItem("Stand"), MenuElements::MenuItem("Crouch"),
												  MenuElements::MenuItem("Jump") });
	elementList.appendElementToList(
		MenuElements::LabelledItem("Stance", { MenuElements::Label("Stance", "Stance"), stanceSelect }));

	elementList.appendElementToList(MenuElements::LabelledItem(
		"Counter", { MenuElements::Label("Counter", "Counter"),
					 MenuElements::Select("Counter", { MenuElements::MenuItem("Off"), MenuElements::MenuItem("On"),
													   MenuElements::MenuItem("Random") }) }));
	...
	elementList.appendElementToList(MenuElements::Window("Display Options", MenuElements::MenuItemList("")));
	elementList.appendElementToList(MenuElements::Button("Return to Character Select"));
...
void testinstantiation()
{
	...
	MenuElements::LabelledItem labelWithElement(
		"labelWithElement", { MenuElements::Label("label", "label"), MenuElements::MenuItem("element") });
